...
def get_last_hour_tweets():
    ...
    initial_date = datetime.datetime.utcnow() - timedelta(hours=5)
...
def build_sentimental_candlestick_graph(financial_data, indicador):
    ...
    plot_url = py.plot(data, filename='test_data', fileopt='extend')
...
def main():
    ...
    build_sentimental_candlestick_graph(financial_data, indicador)
